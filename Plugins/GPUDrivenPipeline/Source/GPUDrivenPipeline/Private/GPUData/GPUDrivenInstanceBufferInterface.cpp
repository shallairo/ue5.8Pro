...
void UGPUDrivenInstanceBufferInterface::UploadTestInstanceData(int32 InstanceCount)
{
    ...
    //3.ENQUEUE_RENDER_COMMAND �ĺ�չ������걾�������������¡�1. ������������֣����ڵ��Ժ����ܷ�����2. �� lambda ��װ��һ����Ⱦ������󣬷Ž���Ⱦ�̵߳��������
    //FRHICommandListImmediate����װ�����з��� GPU �������ͨ��������
    //-������Դ��Buffer��Texture��
    //  - ����״̬����Դת����
    //  - �ύ������Dispatch��Draw��
